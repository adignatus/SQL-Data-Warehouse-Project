...
GO
--------------------------------------------------------------------------------------------------------------------
-- Updated DDLs: This update was necessary to enable me to join tables, tables were not able to join because their 
-- IDs were having different data types
--------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID ('silver.crm_cust_info', 'U') IS NOT NULL
DROP TABLE silver.crm_cust_info;
GO
...
IF OBJECT_ID ('silver.crm_prd_info', 'U') IS NOT NULL
	...
	CREATE TABLE silver.crm_prd_info 
	(
		prd_id  NVARCHAR (50), -- Data type was INT but had a challenge joining it with another tables ID which was NVARCHAR.
	...
	CREATE TABLE silver.crm_sales_details (
		sls_ord_num NVARCHAR(50),
		sls_prd_key NVARCHAR(50),
		sls_cust_id  NVARCHAR (50), -- Data type was INT but had a challenge joining it with another tables ID which was NVARCHAR.
		sls_order_dt DATE,
		sls_ship_dt DATE,
		sls_due_dt DATE,
		sls_sales INT,
